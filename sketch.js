...
function draw() {
  ...
  background(180);
  //displaying score
  text("Score: "+ score, width/2+150, height-300);
  ...
  //console.log(trex.y);
    ...
    cloudsGroup.setLifetimeEach(-1);
     ...
     // added the reset function to gamestate end
...
//destroyed the obstacles and clouds, changed the animation, and reset the score.
function reset(){
  gameState = PLAY;
